...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(2).withKI(0).withKD(0).withKS(0.12).withKV(0.116).withKA(0.007);
  ...
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.84); // 15.9ft/s
